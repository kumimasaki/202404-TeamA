...
public class UsersService {
	...
	// ユーザー登録処理
	public boolean createNotConfirmedUser(String userName, String userEmail, String userPassword) {
		...
		if (usersDao.findByUserEmail(userEmail) == null) {
			notConfirmedUser = new UsersEntity(userName, userEmail, userPassword);
			return true;
		} else {
			return false;
		}
